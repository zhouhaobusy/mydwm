...
# !!! 确保所有item没有重复的 !!!
main_menu_item[1]="set wallpaper"        ; main_cmd[1]='~/scripts/wp-change_me.sh; main_menu;'
...
main_menu_item[6]="auto change the wallpaper"; main_cmd[6]='~/scripts/wp-autochange.sh >> /dev/null &'
